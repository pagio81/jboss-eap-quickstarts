...
@WebServlet("/JavaHeap")
public class JavaHeapServlet extends HttpServlet {

    static String PAGE_HEADER = "<html><head><title>Java Heap</title></head><body>";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for(int i=0; i< loopCount; i++){
            writer.println("<p>Adding in memory i:"+i+"</p>");
            list.add("Index "+i);
            if(i % 1000 == 0)
                writer.flush();
        }
